...
SYMBOL_DATA = [
    {'icon': '🍒', 'name': 'Cherries',   'weight': 20, 'payout_3': 1,   'payout_2': 0},
    {'icon': '🍋', 'name': 'Lemon',      'weight': 30, 'payout_3': 3,   'payout_2': 0},
    {'icon': '🍇', 'name': 'Grapes',     'weight': 20, 'payout_3': 5,   'payout_2': 0},
    {'icon': '🍉', 'name': 'Watermelon', 'weight': 15, 'payout_3': 10,  'payout_2': 0},
    {'icon': '🔔', 'name': 'Bell',       'weight': 8,  'payout_3': 25,  'payout_2': 0},
    {'icon': '💎', 'name': 'Diamond',    'weight': 4,  'payout_3': 100, 'payout_2': 25},
    {'icon': '👑', 'name': 'Crown',      'weight': 1,  'payout_3': 200, 'payout_2': 50}
]
